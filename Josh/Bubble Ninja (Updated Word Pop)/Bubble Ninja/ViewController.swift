...
var sharedSecret = "f18dfed77e2c434abda112ba0616f0d7"

enum RegisteredPurchase : String {
    case UnlockFirstStage = "UnlockFirstStage"
    case UnlockStage2 = "UnlockStage2"
...
class ViewController: UIViewController{
    ...
    let bundleID = "com.funforkidsios"
    
    var UnlockFirstStage = RegisteredPurchase.UnlockFirstStage
    var UnlockStage2 = RegisteredPurchase.UnlockStage2
    ...
    @IBAction func Consumable1(_ sender: Any) {
        purchase(purchase: UnlockFirstStage)
    }
    
    @IBAction func Consumable2(_ sender: Any) {
        purchase(purchase: UnlockStage2)
    }
    ...
    func purchase(purchase : RegisteredPurchase) {
        ...
        SwiftyStoreKit.purchaseProduct(bundleID + "." + purchase.rawValue, completion: {
            ...
            if case .success(let product) = result {
                ...
                if product.productId == self.bundleID + "." + "UnlockFirstStage"{
                    
                    self.Money += 10
                    self.MoneyLbl.text = "\(self.Money)"
                    
                }
                if product.productId == self.bundleID + "." + "UnlockStage2" {
